...
| `scanner.trivy.remoteServer`          | The flag to enable the client/server mode by specifying the remote server URL                                                                                  |                                    |
| `scanner.trivy.serverToken`           | The flag to specify the token for authentication when in client/server mode                                                                                 |                                    |
| `scanner.trivy.insecureRemote`        | The flag to skip verifying certificate when in client/server mode               |                                                                                    | `false`                            |
