...
func TestWrapper_Scan(t *testing.T) {
	...
	config := etc.Trivy{
		...
		DBRepository:     "docker.io/aquasecurity/trivy-db",
		JavaDBRepository: "docker.io/aquasecurity/trivy-java-db",
	...
	expectedCmdArgs := []string{
		...
		"--skip-db-update",
		"--db-repository",
		"docker.io/aquasecurity/trivy-db",
		"--java-db-repository",
		"docker.io/aquasecurity/trivy-java-db",
		"--ignore-unfixed",
		"--no-progress",
		"--severity",
		"CRITICAL,MEDIUM",
